    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link" href="./user-table.php">User Table</a>
        </li>
       

        <li class="nav-item">
          <a class="nav-link" href="./questions.php">Questions Table</a>
        </li>

        
        <li class="nav-item">
          <a class="nav-link" href="./answers.php">Answers Table</a>
        </li>
